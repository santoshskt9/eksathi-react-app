  ...
  return (
    <React.Fragment>
        <div className="infocard">
            <div className="card-side front card1F shadow">
              <h5>Check open request</h5>
            </div>
            <div className="card-side back card1B shadow">
              ...
              <button className="mt-3 btn fw-bold btn-outline-warning rounded">Check Open Request</button>
            </div>
        </div>
        
          <div className="infocard">
            <div className="card-side front card2F shadow">
              <h5>Connect to ekSathi</h5>
            </div>
            <div className="card-side back card2B shadow">
              ...
              <button className="mt-3 btn fw-bold btn-outline-primary rounded"> Connect ekSathi</button>
            </div>
          </div>
          
          <div className="infocard">
            <div className="card-side front card3F shadow">
              <h5>Connect via categories</h5>
            </div>
            <div className="card-side back card3B shadow">
              ...
              <button className="mt-3 btn fw-bold btn-outline-primary rounded"> Connect Via Categories</button>
            </div>
          </div>
          
          <div className="infocard">
            <div className="card-side front card4F shadow">
              <h5>Stories from ekSathi</h5>
            </div>
            <div className="card-side back card4B shadow">
              ...
              <button className="mt-3 btn fw-bold btn-outline-warning rounded"> Stories</button>
            </div>
          </div>
    </React.Fragment>
  )
